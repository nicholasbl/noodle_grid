...
pub mod generator {
  ...
  mod _private {
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[10,11,6,2,0,1,3,4,5,12,9,7,8];
...
pub mod switch_state {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_fault(&mut self, value: i8)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 48] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(189, 79, 107, 46, 11, 204, 197, 233),
      ...
      ::capnp::word(112, 111, 119, 101, 114, 95, 115, 121),
      ::capnp::word(115, 116, 101, 109, 46, 99, 97, 112),
      ::capnp::word(110, 112, 58, 83, 119, 105, 116, 99),
      ::capnp::word(104, 83, 116, 97, 116, 101, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
    ...
    pub const TYPE_ID: u64 = 0xe9c5_cc0b_2e6b_4fbd;
  }
}
...
pub mod switch {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_data(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::power_system_capnp::switch_state::Owned>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn has_data(&self) -> bool {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn get_data(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::power_system_capnp::switch_state::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(2), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_data(&mut self, value: ::capnp::struct_list::Reader<'_,crate::power_system_capnp::switch_state::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(2), value, false)
    }
    #[inline]
    pub fn init_data(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::power_system_capnp::switch_state::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 133] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(199, 19, 194, 200, 249, 251, 118, 128),
      ::capnp::word(19, 0, 0, 0, 1, 0, 4, 0),
      ::capnp::word(239, 193, 125, 32, 197, 34, 149, 187),
      ...
      ::capnp::word(0, 0, 1, 0, 5, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(225, 0, 0, 0, 154, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(228, 0, 0, 0, 3, 0, 1, 0),
      ::capnp::word(240, 0, 0, 0, 2, 0, 1, 0),
      ::capnp::word(6, 0, 0, 0, 3, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 6, 0, 0, 0),
      ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(237, 0, 0, 0, 154, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        2 => <f64 as ::capnp::introspect::Introspect>::introspect(),
        3 => <f64 as ::capnp::introspect::Introspect>::introspect(),
        4 => <::capnp::struct_list::Owned<crate::power_system_capnp::switch_state::Owned> as ::capnp::introspect::Introspect>::introspect(),
        5 => <f64 as ::capnp::introspect::Introspect>::introspect(),
        6 => <f64 as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[5,6,4,0,1,2,3];
    pub const TYPE_ID: u64 = 0x8076_fbf9_c8c2_13c7;
  }
}
